    ...
    <footer className={'dark:bg-primary-dark dark:text-white '}>
      <div className='max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8'>
        <div className='grid grid-cols-1 gap-8 lg:grid-cols-3'>
          <div>
            <BrandLogo className='w-14 h-14 ml-0' />
            <p className='max-w-xs mt-4 text-sm text-gray-600 dark:text-gray-400'>Liên hệ tôi qua</p>
            <div className='flex mt-8 space-x-6 text-gray-600'>
              <a
                className='hover:opacity-75'
                href='https://www.facebook.com/profile.php?id=100088089417691'
                target='_blank'
                rel='noreferrer'
              >
              ...
              <a className='hover:opacity-75' href='https://github.com/giahuy405' target='_blank' rel='noreferrer'>
                <GithubIcon className='w-8 h-8' />
              </a>
              <a
                className='hover:opacity-75'
                href='https://www.youtube.com/@HuyPhamGia-zk8io/videos'
                target='_blank'
                rel='noreferrer'
              >
        ...
        <p className='mt-8 text-xs text-gray-800 dark:text-white'>© 10/10/2023 Gia Huy Dev</p>
      </div>
    </footer>
  )
}
